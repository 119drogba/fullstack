...
<body>
	...
	<form id="studentForm" action="studentinto.pr" method="post" enctype="multipart/form-data">
		...
		<span><%=student.getStudent_id()%></span>
		 <input type="text"
		...
		<span><%=student.getStudent_pw()%></span>
		<input type="password"
		...
		<div>
			...
			<span><%=student.getStudent_name()%></span>
			 <input type="text"
		...
		<div>
			<label for="student_birth">생년월일 선택</label>
			<span><%=student.getStudent_birth()%></span>
			 <input type="date"
		...
		<div>
			<label for="student_intoday">입학 날짜 선택</label>
			<span><%=student.getStudent_intoday()%></span>
			 <input type="date"
		...
		<div class="radio_group">
			<input type="radio" id="g_male" name="ugender" class="hide"
				value="male">
				<span><%=student.getStudent_gender().equals("M") ? "남성" : "여성"%></span>
				<label for="g_male">남자</label><input
				type="radio" id="g_female" name="ugender" class="hide"
				value="female"><label for="g_female">여자</label>

			<div>
				<label for="student_year">학년 선택</label>
				<span><%=student.getStudent_year()%> 학년</span>
			...
			<span> <%=student.getStudent_address()%>
			</span>
			...
			<div>
				...
				<span><%=student.getStudent_status()%></span>
			...
			<div>
				<label for="student_use">사용 가능 여부</label> 
				<span> <%=student.getStudent_use()%>
			</span>
				<select name="student_use"
					id="student_use">
			...
			<label for="student_image">이미지 </label> <input type="file"
				...
				accept=".jpg, .jpeg, .png, .gif" required><br> <input type="button" value="수정" onclick="validateAndSubmit()">
		</div>
