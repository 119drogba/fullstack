...
public class HomeController {
	...
	@RequestMapping("/pathvar/page/{var}") //var=one
	 ...
	 * url 패턴의 범위:
	- 인터넷프로토콜://서버이름(호스트명):포트번호[/컨텍스트패스]/경로....까지
	*** 쿼리스트링은 url 패턴에 포함되지 않는다.
	- 인터넷프로토콜://서버이름(호스트명):포트번호[/컨텍스트패스]/경로....?쿼리스트링
	 */
	@RequestMapping("/pathvar/byGet")
	public String resultByGet(@RequestParam(value = "key1") String k1, @RequestParam(value = "key2") String k2, Model model) {
