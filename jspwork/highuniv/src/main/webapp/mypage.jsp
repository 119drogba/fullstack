...
<div id="menu">
	...
	<div id="content">
		...
		<section id="memberInfoArea">
			...
			<form action="StudentModify" method="post" id="studentForm"
				...
				<table>
					...
					<tr>
						<td>이메일</td>
						<td>${student.student_email}<input type="text"
							name="STUDENT_EMAIL" id="STUDENT_EMAIL" placeholder="변경할 이메일 입력" />
        ...
        <div id="phoneValidMessage" class="valid-message">유효한 전화번호입니다.</div>
					...
					<tr>
						<td>주소</td>
						<td>${student.student_address}<input type="text"
							id="sample6_postcode" name="zipcode" placeholder="우편번호">
							<input type="button" onclick="sample6_execDaumPostcode()"
							value="우편번호 찾기"><br> <input type="text"
							id="sample6_address" name="addr1" placeholder="주소"><br>
							<input type="text" id="sample6_detailAddress" name="addr2"
							placeholder="상세주소"> <input type="text"
							id="sample6_extraAddress" name="comment" placeholder="참고항목"><br>
							<!-- <a href="javascript:modifyboard()">수정</a> -->
						</td>
					</tr>
	...
	<script>
	 function validatePhoneNumber(phoneNumber) {
	        // 전화번호 유효성 검사 (010-1234-5678 형식 또는 숫자 11자리)
	        const phoneRegex = /^01[0|1|6|7|8|9]-?\d{3,4}-?\d{4}$/;
	        return phoneRegex.test(phoneNumber);
	    }

	    // 전화번호 입력 필드에서 블러 이벤트 발생 시 유효성 검사
    ...
    document.addEventListener("DOMContentLoaded", function() {
		...
		function modify() {
			...
			if (email || phone || postcode || address || detailAddress
					|| extraAddress) {
